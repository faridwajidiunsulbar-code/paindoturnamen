...
create table if not exists public.tournaments (
    ...
    date date not null,
    location text,
    status text default 'active' check (status in ('active', 'completed', 'archived', 'closed')),
...
create table if not exists public.divisions (
    ...
    third_place_mode text default 'playoff' not null check (third_place_mode in ('shared_bronze', 'playoff', 'none')),
